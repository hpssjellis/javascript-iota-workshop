...
iota
  ...
  .then(address => {
   ...
   global.myResponse31 = "<h2>3.1-create-address.js</2>Your address is: " + '<pre id="myPre01">'+JSON.stringify(address, null, 3)+'</pre>Paste this address into https://faucet.devnet.iota.org' + "<hr>";  // hopefully this is global
